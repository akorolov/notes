<script lang="ts">
	...
	$: active_note.content, (active_note) ? $noteList = UpdateNote(active_note.id, $noteList, undefined, active_note.content) : null
	$: active_note.tags, (active_note) ? $noteList = UpdateNote( active_note.id, $noteList, undefined, undefined, active_note.tags) : null
